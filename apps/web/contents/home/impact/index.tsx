...
export const ImpactPageContent = () => {
  ...
  const [avgDeliveryFee, setAvgDeliveryFee] = useState<number[]>([500]);
  const [podPercentage, setPodPercentage] = useState<number[]>([60]);
            ...
            <motion.div
              ...
              <div className='relative mb-8'>
                ...
                <blockquote className='text-muted-foreground pl-6 text-lg italic'>
                  &quot;The problem wasn&apos;t the riders. It was the absence
                  of a single of a single system that controlled operations,
                  inventory, payments, and fleet performance.&quot;
                </blockquote>
              </div>
